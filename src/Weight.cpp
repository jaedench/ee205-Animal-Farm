...
void Weight::setWeight(float newWeight) {
    if (weightIsKnown == true && newWeight == UNKNOWN_WEIGHT) {
        throw std::invalid_argument( PROGRAM_TITLE ": You cannot unknow a weight.");
    }
...
void Weight::setMaxWeight(float newMaxWeight) {
    if ( weightHasMax == true ) {
        throw std::invalid_argument( PROGRAM_TITLE ": Max weight already set and cannot be changed.");
    }
